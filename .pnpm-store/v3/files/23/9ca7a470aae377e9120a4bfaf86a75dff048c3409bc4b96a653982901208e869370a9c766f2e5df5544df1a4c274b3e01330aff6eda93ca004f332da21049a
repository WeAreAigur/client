...
function TwitterAppItem({ app , type  }) {
    return /*#__PURE__*/ React.createElement(React.Fragment, null, /*#__PURE__*/ React.createElement(Meta, {
        ...
        content: app.name
    }), /*#__PURE__*/ React.createElement(ExtendMeta, {
...
export function TwitterMetadata({ twitter  }) {
    ...
    }), twitter.images ? twitter.images.map((image)=>/*#__PURE__*/ React.createElement(React.Fragment, null, /*#__PURE__*/ React.createElement(Meta, {
            name: "twitter:image",
            content: image.url
        }), /*#__PURE__*/ React.createElement(Meta, {
            name: "twitter:image:alt",
            content: image.alt
        }))) : null, card === "player" ? twitter.players.map((player)=>/*#__PURE__*/ React.createElement(React.Fragment, null, /*#__PURE__*/ React.createElement(Meta, {
            name: "twitter:player",
