 ...
 */
export declare function serialize(source: VFileCompatible, { scope, mdxOptions, parseFrontmatter, }?: SerializeOptions, rsc?: boolean): Promise<MDXRemoteSerializeResult>;
