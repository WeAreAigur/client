...
export function AlternatesMetadata({ alternates  }) {
    ...
    }) : null, Object.entries(alternates.languages).map(([locale, url])=>url ? /*#__PURE__*/ React.createElement("link", {
            key: locale,
            rel: "alternate",
            hrefLang: locale,
            href: url.toString()
        }) : null), alternates.media ? Object.entries(alternates.media).map(([media, url])=>url ? /*#__PURE__*/ React.createElement("link", {
            key: media,
            rel: "alternate",
            media: media,
            href: url.toString()
