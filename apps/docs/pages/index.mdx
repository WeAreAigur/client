...
A simple chatbot (same model as ChatGPT) with a 1 hour memory in a few lines of code. Try asking it about facts from previous messages (**even after refreshing the page**):
