...
A simple chatbot with memory (1 hour) in a few lines of code. Try asking it about facts from previous messages (**even after refreshing the page**):
...
<Callout>
  This is not ChatGPT, I'm paying for this out of pocket. Please be considerate :)
</Callout>
