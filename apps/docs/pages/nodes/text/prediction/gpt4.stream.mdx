## Name
`gpt4PredictionStream`

## Description

Calls GPT4 and returns the result as a [Stream](/streaming)
...
```ts index.ts
import { gpt4PredictionStream } from '@aigur/client';

//...
flow.node(gpt4PredictionStream, () => ({
  messages: [
    {
      role: 'user',
