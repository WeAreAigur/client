...
export class Builder<T> {
	...
	image = {
		textToImage: {
			stableDiffusion: {
				stability: this.nodeFactory<
					typeof nodeDefinitions.image.textToImage.stableDiffusion.stability
				>(nodeDefinitions.image.textToImage.stableDiffusion.stability),
			},
		},
	};
